<?php
	...
	$reportresults = $obj->spdatimtxmldata($lastreportingperiod,$reportingtable);

	use PhpOffice\PhpSpreadsheet\Spreadsheet;
	use PhpOffice\PhpSpreadsheet\Writer\Xlsx;
	ini_set('memory_limit', '-1');
	$spreadsheet = new Spreadsheet();
	$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load("templates\datimtxmltemplate.xlsx");
	$sheet = $spreadsheet->getActiveSheet();

	$sheet->setCellValueByColumnAndRow(4, 1, $lastreportingperiod);
	$sheet->setCellValueByColumnAndRow(4, 2, 'TxML');
	$i = 5;
	...
	$filename = 'txml'.$lastreportingperiod.'.xlsx';
