    ...
    do {
        ...
        if($quarterscount < 7){
            ...
            echo '<div class="seasonheader iphonessection">';
                echo 'Quarter'.$currentquarternumber.' '.$currentyear.' - Ending:'.$endofreportingperiod;
            echo '</div>';
            echo '<div class="seasonproducts">';
                echo '<div class="tablediv">';
                    echo '<div class="tablerowdiv">';
                        echo '<div class="tablecelldiv">';
                        $countresults = $obj->getselectedreportdatacount($endofreportingperiod);
                            ?>
                            <input type="hidden" value="<?php echo $endofreportingperiod; ?>" id="<?php echo 'enddate'.$quarterscount;?>">
                            <input type="hidden" value="quarter" id="<?php echo 'reportspan'.$quarterscount;?>">
                            <input type="hidden" value="<?php echo $endofreportingperiod; ?>" id="<?php echo 'reportingperiod'.$quarterscount;?>">
...
<?php                        
            ...
            echo '<div class="productcategorylink">';
                ...
                if(in_array("Refresh Data", $userprivilegesarray)){
                    echo '<button class="refreshdatabtn" id="refreshdata'.$quarterscount.'"><i class="fa fa-circle-o-notch" aria-hidden="true"></i> Refresh Data</button>';
                }
            echo '</div>';
