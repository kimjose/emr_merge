                                ...
                                ? (o.showDone
                                      ? (s.done.show(),
                                        s.done.click(function () {
                                            //alert('l'+l+' a'+a+' i'+JSON.stringify(i)+' s'+JSON.stringify(s))
                                            //alert(JSON.stringify(s));
                                            //.statusbar.hide("slow"), s.statusbar.remove();
                                        }))
                                      : s.done.hide(),
                                  o.showDelete
                                      ? (s.del.show(),
            ...
            var w = e.extend(
                {
                    ...
                    uploadStr: "<span class='uploadicon'><i class='fa fa-upload' aria-hidden='true'></i></span><span>CLICK HERE TO SELECT DATABASES TO UPLOAD</span>",
                    abortStr: "Abort",
                    cancelStr: "Cancel",
                    deleteStr: "Delete",
                    doneStr: "<span class='restorestatus'>Restoring..</span>",
