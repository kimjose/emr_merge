...
(function (t, n) {
    ...
    function Et(t) {
        ...
        return (
            ...
            (n = pf.exec(t))
                ? ((n = parseInt(n[1], 16)), new Rt(((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), ((15 & n) << 4) | (15 & n), 1))
                : (n = df.exec(t))
                ? At(parseInt(n[1], 16))
                : (n = vf.exec(t))
        ...
        return 1 === arguments.length
            ? (function (t) {
                  ...
                  var n = (t = t.rgb()).r / 255,
                      ...
                      a = o - i,
                      c = (o + i) / 2;
                  return a ? ((u = n === o ? (e - r) / a + 6 * (e < r) : e === o ? (r - n) / a + 2 : (n - e) / a + 4), (a /= c < 0.5 ? o + i : 2 - o - i), (u *= 60)) : (a = c > 0 && c < 1 ? 0 : u), new Dt(u, a, c, t.opacity);
              })(t)
    ...
    function Ot(t) {
        ...
        return new It(116 * u - 16, 500 * (o - u), 200 * (u - Yt((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / kf)), t.opacity);
    }
    function Ft(t, n, e, r) {
    ...
    function hn(t, n, e, r, i, o) {
        ...
        return (
            ...
            { translateX: i, translateY: o, rotate: Math.atan2(n, t) * Wf, skewX: Math.atan(c) * Wf, scaleX: u, scaleY: a }
        );
    }
    function pn(t, n, e, r) {
        function i(t) {
                        ...
                        .on(
                            ...
                            function () {
                                switch (t.event.keyCode) {
                                    ...
                                    case 32:
                                        T === th &&
                                            (t.event.altKey ? (N && ((p = d - _ * N), (a = s + _ * N)), k && ((v = g - y * k), (l = h + y * k)), (T = eh)) : (N < 0 ? (p = d) : N > 0 && (a = s), k < 0 ? (v = g) : k > 0 && (l = h), (T = nh)),
                                            F.attr("cursor", uh[M]),
                                            o());
                                        break;
                                    default:
    ...
    function Fe(t) {
        function n(t) {
            ...
            var a = (t = De(t)).fill,
                ...
                m = !v || /[defgprs%]/.test(v);
            return (
                (d = null == d ? (v ? 6 : 12) : /[gprs]/.test(v) ? Math.max(1, Math.min(21, d)) : Math.max(0, Math.min(20, d))),
                (n.toString = function () {
                    return t + "";
                }),
                n
                ...
                return {
                    ...
                    point: function (l, h) {
                        ...
                        if ((!i && (s = c = v) && t.lineStart(), v !== c && (!(p = e(i, d)) || Hr(i, p) || Hr(d, p)) && ((d[0] += Mp), (d[1] += Mp), (v = n(d[0], d[1]))), v !== c))
                            ...
                            g & o ||
                                !(_ = e(d, i, !0)) ||
                                ((f = 0), u ? (t.lineStart(), t.point(_[0][0], _[0][1]), t.point(_[1][0], _[1][1]), t.lineEnd()) : (t.point(_[1][0], _[1][1]), t.lineEnd(), t.lineStart(), t.point(_[0][0], _[0][1])));
                        }
    ...
    function hi() {
        ...
        return (
            ...
            (t.extentMajor = function (n) {
                return arguments.length
                    ? ((o = +n[0][0]), (i = +n[1][0]), (s = +n[0][1]), (c = +n[1][1]), o > i && ((n = o), (o = i), (i = n)), s > c && ((n = s), (s = c), (c = n)), t.precision(m))
                    : [
                          [o, s],
                          [i, c],
                      ];
            ...
            (t.extentMinor = function (n) {
                return arguments.length
                    ? ((r = +n[0][0]), (e = +n[1][0]), (a = +n[0][1]), (u = +n[1][1]), r > e && ((n = r), (r = e), (e = n)), a > u && ((n = a), (a = u), (u = n)), t.precision(m))
                    : [
                          [r, a],
                          [e, u],
                      ];
                  ...
                  function e(r, i, o, u, a, c, s, f, l, h, p, d, v, g) {
                      ...
                      if (m > 4 * n && v--) {
                          var x = u + h,
                              ...
                              C = E - i,
                              z = y * A - _ * C;
                          ((z * z) / m > n || zp((_ * A + y * C) / m - 0.5) > 0.3 || u * h + a * p + c * d < jd) && (e(r, i, o, u, a, c, S, E, N, (x /= M), (b /= M), w, v, g), g.point(S, E), e(S, E, N, x, b, w, s, f, l, h, p, d, v, g));
                      }
                  }
                  return function (n) {
                      function r(e, r) {
    ...
    function Yi(t) {
        ...
        return (
            ...
            (n.clipExtent = function (t) {
                return arguments.length
                    ? ((k = null == t ? ((N = f = l = h = null), pi) : Jr((N = +t[0][0]), (f = +t[0][1]), (l = +t[1][0]), (h = +t[1][1]))), i())
                    : null == N
                    ? null
                    : [
                          [N, f],
    ...
    function Xi() {
        return ji().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-0.6, 38.7]);
    }
    function Vi(t) {
        return function (n, e) {
            var r = Lp(n),
    ...
    function fo(t, n) {
        ...
        for (null == n && (n = lo); (e = s.pop()); )
            if ((c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length))) for (e.children = new Array(u), o = u - 1; o >= 0; --o) s.push((r = e.children[o] = new vo(i[o]))), (r.parent = e), (r.depth = e.depth + 1);
        ...
        function e(t, n) {
            return function (e) {
                ...
                if (("p" in u && (u.H = (u.H % 12) + 12 * u.p), "V" in u)) {
                    ...
                    "w" in u || (u.w = 1),
                        "Z" in u
                            ? ((i = (o = (i = Lu(qu(u.y))).getUTCDay()) > 4 || 0 === o ? og.ceil(i) : og(i)), (i = eg.offset(i, 7 * (u.V - 1))), (u.y = i.getUTCFullYear()), (u.m = i.getUTCMonth()), (u.d = i.getUTCDate() + ((u.w + 6) % 7)))
                            : ((i = (o = (i = n(qu(u.y))).getDay()) > 4 || 0 === o ? qv.ceil(i) : qv(i)), (i = Pv.offset(i, 7 * (u.V - 1))), (u.y = i.getFullYear()), (u.m = i.getMonth()), (u.d = i.getDate() + ((u.w + 6) % 7)));
    ...
    Nt(St, Et, {
        ...
        Nt(
            ...
            kt(St, {
                brighter: function (t) {
                    return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Rt(this.r * t, this.g * t, this.b * t, this.opacity);
                },
                darker: function (t) {
                    return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Rt(this.r * t, this.g * t, this.b * t, this.opacity);
                },
                rgb: function () {
                    return this;
                },
        ...
        Nt(
            ...
            kt(St, {
                brighter: function (t) {
                    return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Dt(this.h, this.s, this.l * t, this.opacity);
                },
                darker: function (t) {
                    return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Dt(this.h, this.s, this.l * t, this.opacity);
                },
                rgb: function () {
        ...
        kt(St, {
            ...
            rgb: function () {
                ...
                return (
                    ...
                    (n = Tf * Bt(n)),
                    (e = kf * Bt(e)),
                    new Rt(Ht(3.2404542 * n - 1.5371385 * t - 0.4985314 * e), Ht(-0.969266 * n + 1.8760108 * t + 0.041556 * e), Ht(0.0556434 * n - 0.2040259 * t + 1.0572252 * e), this.opacity)
                );
            },
        })
    ),
    ...
    Nt(
        ...
        kt(St, {
            brighter: function (t) {
                return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new Wt(this.h, this.s, this.l * t, this.opacity);
            },
            darker: function (t) {
                return (t = null == t ? 0.7 : Math.pow(0.7, t)), new Wt(this.h, this.s, this.l * t, this.opacity);
            },
            rgb: function () {
                var t = isNaN(this.h) ? 0 : (this.h + 120) * wf,
                    ...
                    r = Math.cos(t),
                    i = Math.sin(t);
                return new Rt(255 * (n + e * (-0.14861 * r + 1.78277 * i)), 255 * (n + e * (zf * r + Pf * i)), 255 * (n + e * (Rf * r)), this.opacity);
            },
        })
    );
    var Uf,
        ...
        Gf = pn(
            function (t) {
                return "none" === t
                    ? Zf
                    : (Uf || ((Uf = document.createElement("DIV")), (Of = document.documentElement), (Ff = document.defaultView)),
        ...
        Qf = pn(
            function (t) {
                return null == t
                    ? Zf
                    : (If || (If = document.createElementNS("http://www.w3.org/2000/svg", "g")), If.setAttribute("transform", t), (t = If.transform.baseVal.consolidate()) ? ((t = t.matrix), hn(t.a, t.b, t.c, t.d, t.e, t.f)) : Zf);
            },
            ", ",
            ")",
            ")"
            ...
            null === this._x1 ? (this._ += "M" + c + "," + s) : (Math.abs(this._x1 - c) > 1e-6 || Math.abs(this._y1 - s) > 1e-6) && (this._ += "L" + c + "," + s),
                e &&
                    ...
                    l > xh
                        ...
                        : l > 1e-6 && (this._ += "A" + e + "," + e + ",0," + +(l >= yh) + "," + f + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))));
        },
    ...
    (Uh.copy = function () {
        ...
        for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); ) for (var i = 0; i < 4; ++i) (n = r.source[i]) && (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = ke(n)));
        return e;
    }),
        (Uh.add = function (t) {
        ...
        (Uh.remove = function (t) {
            ...
            return (
                ...
                r
                    ...
                    : n
                    ? (i ? (n[l] = i) : delete n[l], (p = n[0] || n[1] || n[2] || n[3]) && p === (n[3] || n[2] || n[1] || n[0]) && !p.length && (e ? (e[h] = p) : (this._root = p)), this)
                    : ((this._root = i), this)
            );
        }),
                ...
                return {
                    ...
                    point: function (o, u) {
                        var a = o > 0 ? Np : -Np,
                            c = zp(o - e);
                        zp(c - Np) < Mp
                            ? (t.point(e, (r = (r + u) / 2 > 0 ? kp : -kp)), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), t.point(o, r), (n = 0))
                            : i !== a &&
                              c >= Np &&
                              (zp(e - i) < Mp && (e -= i * Mp),
                              zp(o - a) < Mp && (o -= a * Mp),
        ...
        (Vc.prototype = {
            ...
            lineEnd: function () {
                ...
                if (e)
                    ...
                    else for (var r = $c(t), i = $c(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
    ...
    (Es.prototype = Ss.prototype),
        ...
        (t.thresholdFreedmanDiaconis = function (t, e, r) {
            return (t = Bs.call(t, i).sort(n)), Math.ceil((r - e) / (2 * (v(t, 0.75) - v(t, 0.25)) * Math.pow(t.length, -1 / 3)));
        }),
        ...
        (t.geoIdentity = function () {
            ...
            return (u = {
                ...
                clipExtent: function (i) {
                    return arguments.length
                        ? ((d = null == i ? ((p = n = e = r = null), pi) : Jr((p = +i[0][0]), (n = +i[0][1]), (e = +i[1][0]), (r = +i[1][1]))), t())
                        : null == p
                        ? null
                        : [
                              [p, n],
            ...
            function t(t) {
                var c = (function (t) {
                    for (var n, e, r, i, o, u = new Ho(t, 0), a = [u]; (n = a.pop()); )
                        if ((r = n._.children)) for (n.children = new Array((o = r.length)), i = o - 1; i >= 0; --i) a.push((e = n.children[i] = new Ho(r[i], i))), (e.parent = n);
        ...
        (t.stackOffsetDiverging = function (t, n) {
            if ((a = t.length) > 1)
                for (var e, r, i, o, u, a, c = 0, s = t[n[0]].length; c < s; ++c) for (o = u = 0, e = 0; e < a; ++e) (i = (r = t[n[e]][c])[1] - r[0]) >= 0 ? ((r[0] = o), (r[1] = o += i)) : i < 0 ? ((r[1] = u), (r[0] = u += i)) : (r[0] = o);
        }),
